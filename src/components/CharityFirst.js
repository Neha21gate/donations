...
class LoginCharity extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(event) {
    ...
    if(this.validate()){
      ...
      this.props.history.push('/charity_add_donor')
  }
}
...
<h1 style={{fontSize: "30px",  color: "black", fontFamily: "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",marginTop:"10%"}}>CHARITY LOG IN</h1><br/><br/><br/>
...
<br/><br/><br/>
    ...
    <button type="submit" className="btn1"  >Log In</button><br/>
      ...
      <Link  to="/forgot-password" style={{textDecoration:"none"}} ><span style={{fontSize:"17px", color:"blue", textDecoration:"none"}}  >Forgotten Password?</span></Link>
      <br/>
     
      
      <Link to="/charity-signup" style={{textDecoration:"none"}}><button className="btn2" >Create New Account</button></Link> <br/><br/><br/> 
