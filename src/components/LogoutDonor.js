...
function LogoutDonor() {
    ...
    <div className="logout">
        ...
        <p style={{fontWeight:"700px", fontSize:"18px", color:"black"}}>Click <Link to="/donor-login" style={{textDecoration:"none", fontWeight:"bold", fontSize:"18px"}}>here </Link>to return to the application</p>
